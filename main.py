...
# nltk.download() #Uncomment this line the first time you run and download the cmudict, used for iambic pentmeter
...
def acrostic(story):
	...
	for sentence in sentences:
		acrosticWord = "".join([i.replace('"','')[0] for i in sentence.split()]) #I f***ing love python sometimes
